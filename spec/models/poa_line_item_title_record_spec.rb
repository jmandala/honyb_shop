...
describe PoaLineItemTitleRecord do
  ...
  context "when creating a new instance" do
    ...
    it "should have a binding" do
      @p.cdf_binding_code.should_not == nil
    end
  ...
  context "when created during an import" do
    ...
    before(:all) do
      ...
      3.times do |i|
        ...
        instance_variable_set "@poa_line_item_title_record_#{i}", FactoryGirl.create(:poa_line_item_title_record, :poa_order_header => @poa_order_header_1)
      end
    end
    ...
    it "should reference the corresponding poa_line_item" do
      ...
      @poa_order_header_1.poa_line_item_title_records.count.should == 3

      # each poa_additional_detail should reference the corresponding poa_line_item
      3.times do |i|
        poa_line_item_title_record = instance_variable_get "@poa_line_item_title_record_#{i}"
        poa_line_item_title_record.should_not == nil
