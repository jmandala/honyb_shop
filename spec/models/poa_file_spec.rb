...
describe PoaFile do
  ...
  context "testing class structure" do
    it "should be possible for instance methods to access class method" do
      PoaFile.class_method
      p = PoaFile.new
      p.instance_method
      p.combo
    end
  ...
  context "when working with remote files" do
    ...
    context "and there is 1 POA files on the server" do
      ...
      it "should download the file, create a PaoFile record, and delete the file from the server" do
        ...
        puts PoaFile.needs_import.first.data
